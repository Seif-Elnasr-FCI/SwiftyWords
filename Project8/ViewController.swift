...
//  Project8
//
//  Created by seif elshahet on 26/11/2023.
//
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            if score % 7 == 0 {
                ...
                ac.addAction(UIAlertAction(title: "Lets`s Go!", style: .default, handler: levelUp))
        ...
        if let levelFileUrl = Bundle.main.url(forResource: "level\(level)", withExtension: "txt") {
            if let levelContent = try? String(contentsOf: levelFileUrl) {
                ...
                for (index, line) in lines.enumerated() {
                    ...
                    let solutionWords = answer.replacingOccurrences(of: "|", with: "")
                    solutionsString += "\(solutionWords.count) letters\n"
                    solutions.append(solutionWords)
